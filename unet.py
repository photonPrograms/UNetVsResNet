def unet_func(input_layer = 16, start_neurons):
    ...
    convm = Conv2D(start_neurons * 16, (3, 3), activation = "relu", padding = "same")(drop4)
    ...
    deconv1 = Conv2DTranspose(start_neurons * 1, (3, 3), strides = (2, 2), padding = "same")(uconv1)
